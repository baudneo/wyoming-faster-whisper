...
async def main() -> None:
    ...
    try:
        # Look for model in rhasspy models repo (original method)
        ...
        _LOGGER.debug("Loading rhasspy hosted model: %s", args.model)
        ...
        _LOGGER.debug(e)
        _LOGGER.warning("Not a rhasspy model, trying HuggingFace...")
    ...
    _LOGGER.info("Ready: %s", model.value)
